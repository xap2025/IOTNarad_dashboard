...
Usage: python check_device_in_database.py <serial_number>
"""
import os
import sys
...
if __name__ == '__main__':
    if len(sys.argv) > 1:
        ...
        list_all_devices()
        print("")
        print("Usage: python check_device_in_database.py <serial_number>")
        print("Example: python check_device_in_database.py DF5647")
